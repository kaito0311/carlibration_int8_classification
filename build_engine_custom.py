...
class EngineBuilder:
    ...
    def create_network(self, onnx_path):
        ...
        self.profile.set_shape("input", (4, 3, 224, 224), (4,3,224,224), (4,3,224,224)) 
    ...
    def create_engine(
        ...
        print(self.network)
        print(self.config)
        print(self.builder.build_engine(self.network, self.config))
...
def main():
    ...
    builder.create_network(onnx_path= "/workspace/tanminh/deepstream6-3/models/OpenClip-ViT-B-v2/Openclip_ViT_B_open_backbone_augment_wo_keep_ratio_add_pseudo_label_0403_2_best.onnx")
    builder.create_engine(
        engine_path= "/workspace/tanminh/Calibration_int8/models/Openclip_ViT_B_open_backbone_augment_wo_keep_ratio_add_pseudo_label_0403_2_best.engine", 
        precision= "int8",
        calib_input= glob.glob("/workspace/tanminh/Calibration_int8/train/*/*.jpg"),
        calib_cache= "/workspace/tanminh/Calibration_int8/models/Openclip_ViT_B_open_backbone_augment_wo_keep_ratio_add_pseudo_label_0403_2_best.cache",
